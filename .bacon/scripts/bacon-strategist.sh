...
EOF
    ...
    jq -c '.problems[]' "$problem_data" | while IFS= read -r problem; do
        ...
        local strategy_approach recommended_action estimated_effort
...
generate_implementation_plan() {
    ...
    # Sort strategies by priority and category
    jq '
