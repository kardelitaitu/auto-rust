# Twitter Activity Refactoring Notes

last audited 08-05-26 by Kilo · re-audited 23-06-26 by Buffy

**Date:** 2026-04-21  
**Purpose:** Historical notes from twitter activity refactoring. 
...
- Nested if-else blocks for like/retweet/quote/follow/dive 
...
engage_with_tweet(api, tweet, action_type): 
  1. Verify context (URL check once) 
...
async fn engage_phase(api) -> Result<()> { 
