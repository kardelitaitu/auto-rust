...
- `.github/workflows/ci.yml` has a dedicated coverage job.
- The job generates HTML and JSON coverage output.
- The job uploads a coverage artifact.
- The job enforces a 40% threshold.
