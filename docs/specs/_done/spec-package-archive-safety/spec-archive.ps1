...
$packagePath = Resolve-Path (Join-Path $root "docs\specs\_active" $PackagePath)
...
$specYaml = Join-Path $packagePath "spec.yaml"
...
$targetDir = Join-Path $root "docs\specs\_done"
