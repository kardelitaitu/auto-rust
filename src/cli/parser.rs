//! CLI parser module for task groups and browser filters.
//!
//! This module handles:
//! - Task group parsing (handling "then" separators)
//! - Browser filter parsing
...
/// # Examples
/// ```
/// use auto::cli::parser::parse_browser_filters;
///
...
/// # Examples
/// ```
/// use auto::cli::parser::parse_task_groups;
///
/// // Single task
...
mod tests {
    ...
    #[test]
    fn test_parse_browser_filters_empty() {
        let filters = parse_browser_filters(None);
        assert!(filters.is_empty());
    }

    #[test]
    fn test_parse_browser_filters_single() {
        let filters = parse_browser_filters(Some("chrome"));
        assert_eq!(filters, vec!["chrome".to_string()]);
    }

    #[test]
    fn test_parse_browser_filters_dedup() {
        let filters = parse_browser_filters(Some("chrome,chrome,chrome"));
        assert_eq!(filters, vec!["chrome".to_string()]);
    }
